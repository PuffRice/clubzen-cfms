...
export function MonthlyReports() {
  ...
  const monthlyData = {
    totalIncome: 5000.00,
    totalExpenses: 2315.49,
    netSavings: 2684.51,
    savingsRate: 53.7,
  };

  const categoryBreakdown = [
    { category: "Groceries", amount: 650.00, percentage: 28 },
    { category: "Utilities", amount: 420.00, percentage: 18 },
    { category: "Transportation", amount: 380.00, percentage: 16 },
    { category: "Entertainment", amount: 315.49, percentage: 14 },
    { category: "Healthcare", amount: 250.00, percentage: 11 },
    { category: "Dining", amount: 200.00, percentage: 9 },
    { category: "Other", amount: 100.00, percentage: 4 },
  ];
